...
| Artifact | Path | Role |
|----------|------|------|
| Domain prompt document | `prompts/samples/domain.md` | The support domain, **declaring an enumerable list of subdomains** (FR-008d). Its hash is a run input; `source_id` derives from it (FR-008a). A slot's subdomain is a seeded choice from that list; the model elaborates the situation within it |
