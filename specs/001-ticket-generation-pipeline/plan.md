...
tests would have silently encoded whichever reading the implementer picked. The design added one dependency beyond the
...
│   ├── revision.py           # Git SHA + dirty flag, input hashing (R10)
