...
- [ ] T013 Implement `export_json_schema()` and a `--check` drift comparison against `specs/001-record-schema-validation/contracts/record.schema.json` in `src/ticket_dataset_generator/schema/export.py` (R1, Principle I)
