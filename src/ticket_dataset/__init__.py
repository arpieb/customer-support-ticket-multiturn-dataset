"""Reproducible generation of multi-turn customer support ticket datasets.
...
from ticket_dataset.config.models import (
    Budget,
    Composition,
    GenerationConfig,
    ModelSpec,
...
from ticket_dataset.dedup import fingerprint as content_fingerprint
...
from ticket_dataset.model.client import ModelClient, ModelResponse, ModelRole
from ticket_dataset.model.fake import FakeModelClient
from ticket_dataset.planning.seeding import slot_random
from ticket_dataset.planning.tolerance import Breach
from ticket_dataset.planning.tolerance import check as check_tolerance
from ticket_dataset.privacy.exceptions_store import ExceptionStore
from ticket_dataset.privacy.masking import mask
from ticket_dataset.privacy.registry import Detector, DetectorRegistry, Finding, ScanReport
...
from ticket_dataset.run.manifest import RunManifest, validate_manifest, validate_manifest_file
from ticket_dataset.run.report import RunReport
from ticket_dataset.run.run import GenerationRun, RunResult
...
from ticket_dataset.schema.record import (
    ConversationTurn,
    GenerationInfo,
    RecordQuality,
    TicketMetadata,
...
from ticket_dataset.schema.version import SCHEMA_VERSION, is_supported_version, parse_semver
