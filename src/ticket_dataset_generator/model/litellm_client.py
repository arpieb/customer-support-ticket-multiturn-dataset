...
else in the package depends on the
:class:`~ticket_dataset_generator.model.client.ModelClient` protocol, which is what lets the
whole test suite run offline against a fake; this module is the only place
...
from ticket_dataset_generator.config.models import GenerationConfig, ModelSpec
