...
:mod:`ticket_dataset_generator.privacy.exceptions_store`. The per-value mechanism is right for
a judgement call about one value; it does not scale to the thousands of distinct fabricated
addresses a
